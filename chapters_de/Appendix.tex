...
\chapter{\ReplicaNextShort{}-Parameterkatalog}\label{appendix:next-parameters-de}

Alle Parameter in diesem Katalog befinden sich auf der Registerkarte \emph{Settings}. Vor dem Bearbeiten muss der jeweilige Parameter geladen werden; laden und bearbeiten Sie immer nur einen Parameter gleichzeitig. Die unten aufgeführten Kennungen sind Firmware-Einstellungen. Gleichnamige Parameterbefehle in der vorherigen Referenz sind getrennte Schnittstellen und dürfen nicht als derselbe Eintrag behandelt werden. Beschriftungen und Firmware-Beschreibungen werden wörtlich wiedergegeben, damit sie auf dem Gerät eindeutig gefunden werden können.

\def\ParameterCatalogueCaption{Firmwareparameter im Register \emph{Settings}}
\def\ParameterCatalogueLabel{tbl:next-parameters-de}
\def\ParameterIdentifier{Kennung}
\def\ParameterUILabel{UI-Beschriftung}
\def\ParameterDescription{Beschreibung}
\def\ParameterValue{Typ / Standard}
\def\ParameterLimits{Grenzen / Hinweise}
