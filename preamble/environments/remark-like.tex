...
%% An environment consists of both \proof and \endproof.  Recent LaTeX
%% releases check both commands when keytheorems declares the replacement, so
%% clearing only \proof leaves the original amsthm end command behind and makes
%% \declarekeytheorem fail with "End of environment 'proof' already defined".
\let\proof\relax
\let\endproof\relax
