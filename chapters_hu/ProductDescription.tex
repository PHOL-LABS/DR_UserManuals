...
REFIZ & ReFIZ alaplap gyári Volkswagen Digifiz kijelzőegységekhez; kiváltja a gyári alaplapot, és kompatibilis marad a Digifiz Next architektúrával. \\
...
\subsection{Mk3-as \ReplicaNextShort{} kiosztás}
A \ReplicaNextShort{} műszerekhez adott Mk3-as adapterköteg egyetlen 28 pólusú csatlakozóban végződik. A lábkiosztás a
gyári Volkswagen Digifiz Mk3 rajzát követi, így közvetlenül a biztosítéktáblába vagy a jármű adaptereibe csatlakoztatható
(\autoref{tab:mk3-pinout-hu}).
...
\begin{table}[htbp]
    ...
    Láb & Funkció \\
    1 & Külső levegőhőmérséklet-érzékelő~\mbox{-G17-}, test (GND)\textsuperscript{$\dagger$}. \\
    2 & Hűtőfolyadék-szint érzékelő~\mbox{-G32-}. \\
    3 & 31-es kapocs, járműtest. \\
    4 & \textsc{MFA} memória gomb~\mbox{-E109-}, reset-ág\textsuperscript{$\dagger$}. \\
    5 & 31-es kapocs, járműtest. \\
    6 & \textsc{MFA} memória gomb~\mbox{-E109-}, memória-ág\textsuperscript{$\dagger$}. \\
    7 & Járműsebesség-érzékelő (VSS) kimenet. \\
    8 & Olajnyomás-kapcsoló~\mbox{-F1-}, \SI{1.8}{bar}. \\
    9 & Olajnyomás-kapcsoló~\mbox{-F22-}, \SI{0.3}{bar}. \\
    10 & 1-es / W kapocs, fordulatszám bemenet. \\
    11 & 30-as kapocs, akkumulátor-táp (B+). \\
    12 & 58b kapocs, világítás. \\
    13 & 15-ös kapocs, gyújtásról kapcsolt B+. \\
    14 & Nincs bekötve. \\
    15 & \textsc{MFA} módválasztó kapcsoló~\mbox{-E86-}. \\
    16 & Generátor visszajelző~\mbox{-K2-}, 61-es kapocs. \\
    17 & Motorolaj-hőmérő érzékelő~\mbox{-G8-}\textsuperscript{$\dagger$}. \\
    18 & Fék- és rögzítőfék-visszajelző~\mbox{-K7-}. \\
    19 & Külső hőmérséklet-érzékelő~\mbox{-G17-}, jel\textsuperscript{$\dagger$}. \\
    20 & Motorhiba visszajelző~\mbox{-K83-} vagy dízel izzítás visszajelző~\mbox{-K29-}. \\
    21 & Üzemanyagszint-mérő~\mbox{-G1-}. \\
    22 & Bal irányjelző visszajelző~\mbox{-K65-}. \\
    23 & Hűtőfolyadék-hőmérő~\mbox{-G3-}. \\
    24 & Jobb irányjelző visszajelző~\mbox{-K94-}. \\
    25 & Távolsági fényszóró visszajelző~\mbox{-K1-}. \\
    26 & Fogyasztásjel bemenet\textsuperscript{$\dagger$}. \\
    27 & Sebességjel a kilométeróra VSS érzékelőjétől~\mbox{-G22-}. \\
    28 & Automata váltó fokozatkijelző (AG4). \\
    \end{tblr}}
    \caption{Az Mk3-as \ReplicaNextShort{} kábelkorbács kiosztása.}
    \label{tab:mk3-pinout-hu}
\end{table}

Az \textsuperscript{$\dagger$} jellel jelölt ágak a 28 pólusú házból a készlethez adott JST elosztókon lépnek ki. Ezek sodort
párokat biztosítanak a külső és olajhőmérséklet érzékelőkhöz, valamint közvetlen hozzáférést az \textsc{MFA} gombokhoz és a
fogyasztásjelhez.

\subsection{A ReFIZ alaplap lábkiosztása}
A ReFIZ cserealaplap eredeti Volkswagen Digifiz kijelzőegységekhez. A Digifiz Next architektúrát követi, ezért a webes kezelőfelület és minden egyéb konfigurációs funkció megegyezik a \ReplicaNextShort{} megoldással. A gyári alaplap kiszerelhető és ReFIZ-re cserélhető. A színmódosítás négy LED-helyre és a visszajelzők sorára korlátozódik. A fogyasztásjeladó alapértelmezetten csatlakoztatva van, a fényerő egy további analóg bemeneten kézzel is vezérelhető, a járműjelek pedig a fő készülékcsatlakozón érhetők el. Opcionális CE~2 csatlakozó is rendelkezésre áll, ahogy a többi Digifiz Next kábelkötegnél szerepel.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{digifiz_manual/refiz.png}
    \caption{A ReFIZ alaplap lábkiosztásának áttekintése.}
    \label{fig:refiz-pinout-hu}
\end{figure}

\noindent\textbf{W csatlakozó -- L oldal (WL)}
...
Láb & Funkció & Leírás \\
WL7 & Sebességmérő bemenet & Sebességmérő jel a jeladótól. \\
WL6 & MFA nullázás & Nullázza az MFA fedélzeti számítógép értékeit. \\
WL5 & Óra -- percbeállítás & A műszerfalóra percállító bemenete, 12~V szint. \\
WL4 & 31-es kapocs (test) & Karosszéria-test csatlakozás. \\
WL3 & Kézifék visszajelző & Aktiválja a rögzítőfék figyelmeztető jelzését. \\
WL2 & Bal irányjelző & A bal irányjelző visszajelző lámpáját vezérli. \\
WL1 & Hátsó ablakfűtés & A hátsó páramentesítő működését jelzi. \\
\end{tblr}}

\noindent\textbf{W csatlakozó -- K oldal (WK)}
...
Láb & Funkció & Leírás \\
WK7 & KL1 fordulatszámjel & Jel a gyújtótekercs vagy elosztó egységből. \\
WK6 & Óra -- órabeállítás & A műszerfalóra óraállító bemenete, 12~V szint. \\
WK5 & MFA mód & Kapcsolóbemenet az MFA módok váltásához. \\
WK4 & 61-es kapocs & Generátor töltésjel (akkumulátor visszajelző) és gerjesztés. \\
WK3 & Jobb irányjelző & A jobb irányjelző visszajelző lámpáját vezérli. \\
WK2 & Távolsági fény visszajelző & A távolsági fény figyelmeztető lámpáját vezérli. \\
WK1 & Hátsó ködlámpa & Jelzi a hátsó ködlámpák bekapcsolását. \\
\end{tblr}}

\noindent\textbf{S csatlakozó -- L oldal (SL)}
...
Láb & Funkció & Leírás \\
SL9 & 58-as kapocs & Műszervilágítás tápja a világításkapcsolótól. \\
SL8 & MFA blokk kapcsoló & Bemenet az MFA blokk választókapcsolótól (kormánykapcsoló). \\
SL7 & 15-ös kapocs & Gyújtáskapcsolt +12~V táp. \\
SL6 & 58b kapocs & Műszerfal-világítás fényerőszabályzó bemenet. \\
SL5 & Olajnyomás kapcsoló (1,8~bar) & Magasnyomású olajkapcsoló bemenet. \\
SL4 & N/C; nincs a PCB-re vezetve (non-Rabbit) & Ismeretlen. \\
SL3 & N/C; nincs a PCB-re vezetve (non-Rabbit) & Ismeretlen. \\
SL2 & Olajhőmérséklet jeladó & Olajhőmérő/MFA érzékelőbemenet. \\
SL1 & Üzemanyagszint jeladó & Tank szintjeladó bemenet. \\
\end{tblr}}

\noindent\textbf{S csatlakozó -- K oldal (SK)}
...
Láb & Funkció & Leírás \\
SK9 & 58-as kapocs & Világítás visszajelző. \\
SK8 & Hűtőfolyadék szintérzékelő & Alacsony hűtőfolyadékszint jel. \\
SK7 & Ismeretlen +12~V jelbemenet & Ismeretlen; egyes források szerint változó olajnyomás-jeladó kimenet. \\
SK6 & Nincs bekötve/ismeretlen & A non-Rabbit változatban nincs a PCB-re vezetve. \\
SK5 & 31-es kapocs (test) az MFA-hoz & MFA testcsatlakozás; kötelező a hibás működés elkerüléséhez. \\
SK4 & 30-as kapocs, állandó táp & Állandó akkumulátor +12~V táp. \\
SK3 & Olajnyomás kapcsoló (0,3~bar) & Alacsony olajnyomás figyelmeztető bemenet. \\
SK2 & Hűtőfolyadék hőmérséklet jeladó & Motor hűtőfolyadék-hőmérséklet bemenet. \\
SK1 & Külső hőmérséklet jeladó & Az MFA által használt környezeti hőmérséklet érzékelő. \\
\end{tblr}}

Az eredeti csatlakozók nehezen beszerezhetők; nyomtatható aljzatmodell itt érhető el:
...
\subsection{Megfelelő elektronikus sebességjeladók}
Bármely kompatibilis Hall-jellegű kimenettel rendelkező elektronikus járműsebesség-jeladó használható a műszeregységgel. Az ajánlott jeladó a \mbox{IG0919149A/1H0919149A} a \mbox{357972753} csatlakozó párral; ha a beépítéshez a másik aljzatkivitel szükséges, használja a \mbox{1H0919149C} jeladót a \mbox{1J0973723} csatlakozó párral.

Kompatibilis alternatívák a \mbox{191919149D}, a \mbox{NTYECP-AU-033} és a \mbox{357919149B/357919149}, amelyeket gyakran O2A és O2J váltóknál használnak. Ezek a jeladók ugyanazt az elektromos interfészt használják, ezért teljesen kompatibilisek. A váltóban lévő meghajtó fogaskerék színe nem kritikus: a piros fogaskerékkel szállított jeladó akkor is megfelelően működik, ha a váltóban korábban fehér fogaskerék volt.

A sebességmérő jelét a 14 tűs (2~x~7) \mbox{KF2510} kiegészítő jelcsatlakozón keresztül kell bekötni; használja a fenti csatlakozó-lábkiosztásban szereplő sebességjeladó bemenetet.
