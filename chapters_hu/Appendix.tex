...
\chapter{A \ReplicaNextShort{} paraméterkatalógusa}\label{appendix:next-parameters-hu}

A katalógus minden paramétere a \emph{Settings} lapon található. Módosítás előtt töltse be a paramétert, és egyszerre csak egy paramétert töltsön be és szerkesszen. Az alábbi azonosítók firmware-beállítások; az előző hivatkozás hasonló nevű paraméterparancsai különálló interfészek, ezért nem azonos bejegyzések. A felületi címkék és firmware-leírások szó szerint szerepelnek, így a készüléken egyértelműen azonosíthatók.

\def\ParameterCatalogueCaption{Firmware-paraméterek a \emph{Settings} lapon}
\def\ParameterCatalogueLabel{tbl:next-parameters-hu}
\def\ParameterIdentifier{Azonosító}
\def\ParameterUILabel{Felületi címke}
\def\ParameterDescription{Leírás}
\def\ParameterValue{Típus / alapérték}
\def\ParameterLimits{Határ / megjegyzés}
