...
\begin{table}[htbp]
    ...
    \begin{tblr}{
        ...
        15 & \paramname{PARAMETER\_TANK\_CAPACITY} & Üzemanyagtartály kapacitása literben (0--99; Golf~II/III és Vento esetén jellemzően 55~L). \\
...
A \emph{Colors} lap szegmensalapú szerkesztőt kínál a WS2812 LED háttérvilágításhoz. Minden sor egy tartománylezárást, a hozzárendelt funkcionális területet és az adott tartományhoz használt színtípust írja le. A színtípus-választóban a \emph{Main color} a \emph{Control} lapon aktuálisan beállított RGB értéket használja, a \emph{Main color /3} ugyanezt a főszínt egyharmad intenzitással (háromszor sötétebben), a \emph{Custom color} az ezen a \emph{Colors} lapon kiválasztott RGB értéket, a \emph{Back color} pedig a \emph{Control} lap háttérvilágítási színét.
