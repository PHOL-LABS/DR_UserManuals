...
\begin{table}[htbp]
    ...
    \begin{tblr}{
        ...
        15 & \paramname{PARAMETER\_TANK\_CAPACITY} & Capacité du réservoir en litres (0--99 ; 55~L typiques pour Golf~II/III et Vento). \\
...
L'onglet \emph{Colors} fournit un éditeur par segments pour le rétroéclairage WS2812. Chaque ligne définit une fin de plage, la zone fonctionnelle concernée et le type de couleur utilisé pour cette plage. Dans le sélecteur de type de couleur, \emph{Main color} reprend la valeur RVB actuellement réglée dans l'onglet \emph{Control}, \emph{Main color /3} reprend cette même couleur principale avec un tiers de son intensité (trois fois plus sombre), \emph{Custom color} utilise la valeur RVB choisie directement dans cet onglet \emph{Colors}, et \emph{Back color} utilise la couleur de rétroéclairage de l'onglet \emph{Control}.
